...
export const getPlans = async () => {
    return errorHandler<GetPlans>(() => fetch('/api/load_all_plans', { method: 'POST', headers: { "Content-Type": "application/json" } }))
}
...
export const getPlan = async () => {
    return errorHandler<GetPlan>(() => fetch('/api/load_plan', { method: 'POST', headers: { "Content-Type": "application/json" } }))
}
...
export const choosePlan = async (id: string) => {
    return errorHandler<ChoosePlan>(() => fetch('/api/choose_plan', { 
        method: 'POST', 
...
export const updatePlan = async (planName: string, widgets: GetPlanJsonWidget[]) => {
    return errorHandler<UpdatePlan>(() => fetch('/api/update_plan', {
        method: 'POST',
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ name: planName, widgets: JSON.stringify(widgets) })
    }))
